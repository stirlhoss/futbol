...
class StatTracker
  ...
  def initialize(stats)
    ...
    @game_teams = GameTeams.game_build(stats)
  end
  ...
  def best_offense
    ...
    @teams.find{ |row| row.team_id == team}.team_name
  end
  ...
  @teams.find {|row| row.team_id == team_id}.team_name
  end
  ...
  def favorite_opponent(team_id)
    ...
    @teams.find {|row| row.team_id == favorite_team_id}.team_name
  end
  ...
  def rival(team_id)
    ...
    @teams.find {|row| row.team_id == rival_team_id}.team_name
  end
end
